						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#SensorManager-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"SensorManager-display": {
								"semanticObject": "SensorManager",
								"action": "display",
								"description": "A Fiori application for managing sensors",
								"title": "Sensor Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=keepcool.sensormanager",
									"url": sap.ui.require.toUrl("keepcool/sensormanager")
								}
							}
						}
					}
